...
public class textUi {
    ...
    private void addUser() {
        ...
        if(type == 1){
            librarySystem.addStudent(name, true);
        }else if(type == 2){ 
            printText.department();
            String department = scanner.nextLine();        
            librarySystem.addFacultyMember(name, department);
        }
        else{
            printText.invalidChoice();
        }
    ...
    private void addInitialData() {
        try {
            ...
            // Adding students
            librarySystem.addStudent("Harry Potter", true);
            librarySystem.addStudent("Hermione Granger", true);
            librarySystem.addStudent("Ron Weasley", true);
            librarySystem.addStudent("Neville Longbottom", false);
    
            // Adding faculty
            librarySystem.addFacultyMember("Albus Dumbledore", "Wizard");
            librarySystem.addFacultyMember("Severus Snape", "Potions Master");
            librarySystem.addFacultyMember("Minerva McGonagall", "Witch");
            librarySystem.addFacultyMember("Rincewind", "Wizard");
